...
window.onload = setTimeout( () => {
    document.querySelector('.pg4').style.transform = "scale(1, 1)";
}, 300);
window.onload = setTimeout(() => {
    document.querySelector('.pg3').style.transform = "scale(1, 1)";
}, 400);
window.onload = setTimeout(() => {
    document.querySelector('.pg2').style.transform = "scale(1, 1)";
}, 500);
